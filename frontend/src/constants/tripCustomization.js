 ...
 * Should match the backend configuration.
 */
export const CSRF_HEADER_NAME = 'X-CSRF-Token';

/**
 * CSRF_COOKIE_NAME
 * The name of the cookie where the CSRF token value might be stored by the backend
 * for the frontend to read.
 */
export const CSRF_COOKIE_NAME = '_csrfToken';
